    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organisation.CourseOrg', verbose_name='\u8bfe\u7a0b\u6240\u5c5e\u673a\u6784')),
            ],
            options={
                'verbose_name': '\u8bfe\u7a0b\u4fe1\u606f',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(default='', max_length=20, verbose_name='\u89c6\u9891\u5730\u5740')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='\u8bfe\u7a0b')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='courses.CourseType', verbose_name='\u8bfe\u7a0b\u7c7b\u522b'),
        ),
    ]
